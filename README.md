...
Before starting the project, make sure to configure the environment variables.
...
2. Open the `.env` file and fill in the necessary values (e.g., database credentials, ports, secret keys, etc.).

> ⚠️ **Important:** Never commit the `.env` file to the repository, as it may contain sensitive information.
